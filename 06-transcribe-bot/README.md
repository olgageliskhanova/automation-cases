...
| Доступ по запросу + карточка результата с кнопками | Новые пользователи проходят approval у админа; готовый результат выдаётся карточкой с inline-кнопками — «только суть» и «скачать .docx». |
