...
Публичное портфолио кейсов по автоматизации и AI-инжинирингу. Восемь production-проектов: AI-боты с RAG, многоязычный куратор сообщества с модерацией, генерация контента, конкурентная разведка, обработка лидов, гибридная транскрипция речи, авто-дубляж видео-курсов на четыре языка.
...
| 08 | [Авто-дубляж видео-курсов (EN→TR/ES/DE/AR)](./08-course-dubbing/) | Python · ffmpeg · Gemini · ElevenLabs · Edge-TTS · Whisper · VAD/rubberband · Kinescope | ASR→перевод→клон голоса→тайминг→мукс; мультидорожка + сабы, round-trip QA |
...
**Медиа / Аудио:** ffmpeg · ElevenLabs · Edge-TTS · Chatterbox / F5-TTS · WebRTC VAD · rubberband · Kinescope
**CRM:** amoCRM · Bitrix24
...
- **Детерминированный QA вместо «на слух»** — для дубляжа готовая озвучка распознаётся обратно (Whisper round-trip) и сверяется с переводом, а не оценивается ухом
